...
const NutritionalSol = ({ category, onBack }) => {
    ...
    if (category === "Exercises") {
        itemsToDisplay = exerciseNutritional;
        heading = "Exercise you should do";
    } else if (category && FoodNutritional[category]) {
        itemsToDisplay = FoodNutritional[category];
